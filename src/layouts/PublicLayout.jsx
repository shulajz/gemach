...
const PublicLayout = () => (
  <div className="relative isolate min-h-screen">
    ...
    <header className="relative z-10 overflow-hidden bg-gradient-to-l from-teal-800 to-teal-600 text-white shadow-xl">
      ...
      <div className="relative mx-auto max-w-4xl px-3 py-4 sm:px-4 sm:py-5 md:py-10">
        <h1 className="text-xl font-bold leading-snug tracking-tight sm:text-3xl md:text-4xl">
          גמ&quot;ח כלים לאירועים &quot;חסדי אביעד&quot; פרדס חנה
        </h1>
        <p className="mt-2 text-sm leading-relaxed text-teal-100 sm:text-lg md:text-xl">
        ...
        <div className="mt-4 flex w-full flex-col gap-2 sm:flex-row sm:flex-wrap sm:gap-3">
          <NavLink
            to="/"
            className={({ isActive }) =>
              `inline-flex min-h-11 w-full items-center justify-center rounded-xl border-2 px-4 py-3 text-sm font-semibold transition-colors sm:w-auto ${
    ...
    <main className="relative z-10 mx-auto max-w-4xl px-3 py-5 sm:px-4 sm:py-8 md:py-10">
      <Outlet />
    </main>
    <footer className="relative z-10 mt-8 border-t-2 border-teal-200 bg-teal-800 px-3 py-6 text-center text-xs leading-relaxed text-teal-100 sm:text-sm md:mt-16">
      גמ&quot;ח כלים לאירועים &quot;חסדי אביעד&quot; פרדס חנה ©
    </footer>
  </div>
);
